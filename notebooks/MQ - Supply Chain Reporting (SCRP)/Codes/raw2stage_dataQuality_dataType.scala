...
val rawtablename = s"supplychain_raw_db.${raw_object_name}"
...
dbutils.notebook.exit(s"Data Quality Datatype Service completed for $business_name: $object_name")